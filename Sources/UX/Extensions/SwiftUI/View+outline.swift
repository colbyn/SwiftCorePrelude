...
fileprivate let DEFAULT_BORDER_COLOR = LLColorMap(
...
fileprivate struct ViewBorderModifier: ViewModifier {
    let edges: Edge.Set
    var borderColor: LLColorMap?
    var lineWidth: CGFloat?
    func body(content: Content) -> some View {
        let color = (borderColor ?? DEFAULT_BORDER_COLOR).apply(colorScheme: colorScheme).asColor
...
extension View {
    public func outline(_ edges: Edge.Set, color: LLColorMap? = nil, lineWidth: CGFloat? = nil, show: Bool = true) -> some View {
