...
// MARK: - PUBLIC API -
extension View {
    public func readViewRect(coordinateSpace: CoordinateSpace, onChange: @escaping (CGRect) -> ()) -> some View {
        modifier(RectPreferenceViewModifier(coordinateSpace: coordinateSpace, onChange: onChange))
    }
    public func readViewRect(onChange: @escaping (CGSize) -> ()) -> some View {
